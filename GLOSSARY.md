...
### APA 7
> De la Serna Tuya, J. M. (2025). *Glosario de términos clave: conectomica-cerebral-humana-base-de-datos-de-conectividad-estructural-y-funciona* [Glossary of key terms]. GitHub. https://github.com/juanmoisesd/conectomica-cerebral-humana-base-de-datos-de-conectividad-estructural-y-funciona/blob/main/GLOSSARY.md

### BibTeX
```bibtex
@misc{delaserna2025_conectomica_cerebral_humana_ba,
  author       = {De la Serna Tuya, Juan Moisés},
  title        = {Glosario de Términos Clave / Glossary of Key Terms: conectomica-cerebral-humana-base-de-datos-de-conectividad-estructural-y-funciona},
  year         = {2025},
  publisher    = {GitHub},
  url          = {https://github.com/juanmoisesd/conectomica-cerebral-humana-base-de-datos-de-conectividad-estructural-y-funciona/blob/main/GLOSSARY.md},
  note         = {ORCID: 0000-0002-8401-8018}
}
```

### Chicago
> De la Serna Tuya, Juan Moisés. "Glosario de Términos Clave: conectomica-cerebral-humana-base-de-datos-de-conectividad-estructural-y-funciona." GitHub, 2025. https://github.com/juanmoisesd/conectomica-cerebral-humana-base-de-datos-de-conectividad-estructural-y-funciona/blob/main/GLOSSARY.md.
